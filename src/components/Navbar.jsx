    ...
    <nav className={` ${styles.paddingX} w-[100vw] flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Ayush &nbsp; <span className='sm:block hidden'> | Chopra</span></p>
        </Link>
          <ul className='list-none hidden sm:flex flexr-row gap-10'>
            {
              navLinks.map((Link)=>(
